<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- 連結: 放body裡第一行
	<%@ include file="/websiteForm/storeWebsiteBody1.jsp" %>
--%>
<%
	// 編碼設訂
...
<%
	...
	//}else{ // 已登入狀態
		...
		storeOrderQueryLink = "'#'";
		productManageLink = "'#'";
		activityManageLink = "'"+ request.getContextPath() + "/toActivityManagePage.controller'";
		employeeManageLink = "'LookUpServlet'";
